...
namespace BaseFramework
{
	...
	public class Gun_Master : MonoBehaviour 
	{
        ...
        public delegate void GunNpcEventHandler(float _random);
        ...
        {
            if (EventRequestReload != null && isReloading == false)
            {
                isReloading = true;
                EventRequestReload();
            }
        ...
        public void CallEventNpcInput(float _random)
        {
            if (EventNpcInput != null) EventNpcInput(_random);
        }
    }
}
